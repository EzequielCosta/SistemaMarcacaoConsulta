    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="consultas">
                ...
                <h3  style="color: #007bff; text-align: center; margin-top: 20px;" >Consultas Realizadas</h3>;
                ...
                echo "<th scope = 'col'>Horario de Atendimento</th>";
                ...
                $conexao = new Conexao();
                $sql_consulta = "SELECT *,CON.ID AS ID FROM CONSULTA AS CON JOIN REGISTRO_ATENDIMENTO AS RA ON CON.ID = RA.CONSULTA_ID";
                ...
                foreach ($result_consulta as $elemento) {
                    ...
                    if ($elemento["data_efetiva"] != null && $elemento["horario_efetivo"] != null) {
                        echo "<td style = 'text-align: center'>" . $elemento["data_efetiva"] . "</td>";
                        echo "<td style = 'text-align: center'>" . $elemento["horario_efetivo"] . "</td>";
                    } else {
                        echo "<td>" . $elemento["data_agendamento"] . "</td>";
                        echo "<td>" . $elemento["horario"] . "</td>";
                    }
                    ...
                    echo "<td><a href='deletar_consultas_realizadas.php?cod=" . $elemento['id'] . "' >Deletelar</a></td>";

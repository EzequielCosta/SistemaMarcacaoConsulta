...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="consultas">
                <h3  style="color: #007bff; text-align: center; margin-top: 20px;" >Listas de Médicos</h3>;

                <?php
                try {

                    if (isset($_SESSION["erro_delete"]) && $_SESSION["erro_delete"]) {
                        echo '<div class="alert alert-danger" style="margin: 10px auto 0px auto; width: 50%; text-aligh:center">';
                        echo '<strong style = "text-aligh: center;">O médico possui uma consulta agendada! </strong>';
                        echo '</div>';
                ...
                echo "<tr>";
                echo "<th scope = 'col'>Código do Médico</th>";
                ...
                foreach ($result as $i) {
                    ...
                    echo "<td> <a href='ver_tudo_medico_view.php?cod=" . $i['id'] . "' >" . $i["nome"] . "</a> </td>";
                    echo "<td class = 'cpf_medico'>" . $i["cpf"] . "</td>";
                    echo "<td>" . $i["data_nascimento"] . "</td>";
                    echo "<td>" . $i["sexo"] . "</td>";
                    echo "<td><a href='atualizar_medico_view.php?cod=" . $i['id'] . "' >Atualizar dados</a></td>";
                    echo "<td><a  href='deletar_medico.php?cod=" . $i['id'] . "' value='deleta' >Deletelar dados</a></td>";
                    echo "</tr>";
                }
                echo "</tbody>";
                echo "</table>";

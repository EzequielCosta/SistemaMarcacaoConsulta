    ...
    <body>
        ...
        <div id="container">
            ...
            <div style="margin-top: 70px; width: 40%;" class="container">
                <h3  style="color: #007bff; text-align: center; margin-top: 20px;" >Cadastro de Procedimento</h3>
                <?php
                try {
                ...
                ?>     
                <form action="../controller/ProcedimentoController.php" method="POST" class="needs-validation" novalidate>

                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <label for="nome_procedimento">Nome </label>
                                <input type="text" class="form-control" autocomplete="off" maxlength="45" id="nome_paciente" oninput="maiusculo(event)" name="nome_procedimento" placeholder="Nome Procedimento" required>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" autocomplete="off" maxlength="3" id="idade_minima" name="idade_minima" placeholder="Idade mínima" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type = "text" class="form-control" autocomplete="off" maxlength="3" id="idade_maxima" name="idade_maxima" placeholder="Idade máxima" required>
                            </div>
                        </div>
